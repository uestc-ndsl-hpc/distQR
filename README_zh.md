...
- `--broadcast-mode <panel|block>`：为 factorization 路径选择 panel 级或 block 级广播。它既适用于 `bench_dist_blocked_qr_col_blockcyclic`，也适用于 `bench_dist_orgqr_col_blockcyclic --e2e`。
